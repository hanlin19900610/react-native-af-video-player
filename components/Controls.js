...
class Controls extends Component {
  ...
  showControls() {
    this.setState({ hideControls: false }, () => {
      ...
      Animated.parallel([
        Animated.timing(this.animControls, { toValue: 1, duration: 200, useNativeDriver: true }),
  ...
  hiddenControls() {
    Animated.timing(this.progressbar, { toValue: 0, duration: 200, useNativeDriver: true }).start()
    return (
